...
define('resources',['vendor/gf'], function(gf) {
    ...
    var resources = {
        ...
        startup: function(game, progress, complete) {
            ...
            resources.worls.forEach(function(w) {
...
require([
    ...
    function runGame() {
        ...
        resources.worlds.forEach(function(w) {
            ...
            state.world.children[0].spawnObjects();
        ...
        game.enableState(resources.worlds[0]);
